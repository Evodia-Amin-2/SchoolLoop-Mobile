(function() {
    ...
    angular.module('mobileloop')
        .controller('SupportController', ['$scope', '$window', 'DataService', 'StorageService', 'gettextCatalog', SupportController])
        ;

        function SupportController($scope, $window, dataService, storageService, gettextCatalog) {
            var support = this;
