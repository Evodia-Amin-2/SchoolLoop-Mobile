(function() {
    ...
    function AddStudentController($rootScope, $scope, storageService, dataService, statusService, gettextCatalog) {
        ...
        page.addStudent = function() {
            ...
            if(numStudents > 0) {
                ...
                if(numStudents > 2) {
                    ...
                    message = message.replace("{name1}", student.name);
                    message = message.replace("{name2}", page.students[1].name);
                } else {
        ...
        page.changeSchool = function() {
            $scope.mainNavigator.pushPage("change-school.html", {data: {searchCallback: page.addSchool}});
        };
